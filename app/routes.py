...
from app.forms import PostForm, RegistrationForm, EmptyForm, ResetPasswordForm

from flask import render_template, flash, redirect, url_for, request
from werkzeug.urls import url_parse

from app.forms import LoginForm, EditProfileForm, PostForm, ResetPasswordRequestForm
...
# Route to reset password request 
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Check your email for the instructions to reset your password. Also check the spam folder.!')
        return redirect(url_for('login'))
